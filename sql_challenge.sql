...
--CREATE TABLE employees(emp_no INT, emp_title_id VARCHAR(30), birth_date DATE, first_name VARCHAR(30), last_name VARCHAR(30), sex VARCHAR(1), hire_date DATE);
--CREATE TABLE salaries(emp_no INT, salary INT);
--CREATE TABLE titles(emp_title_id VARCHAR(30), title VARCHAR(30));
